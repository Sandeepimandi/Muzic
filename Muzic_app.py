...
st.title("Muzic")
st.write('Muzic is emotion detection based music reccommendation system. To get reccommended songs, start by allowing mic and camera for this web app.')
...
st.write('Made with ❤ by [Sandeep](https://github.com/Sandeepimandi/Muzic)')
